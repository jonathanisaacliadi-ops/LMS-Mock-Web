...
// Matches the "sudut prediksi" passage shown in this (dark) build.
// answer: 'B' = Benar (true), 'S' = Salah (false)
const QUIZ = [
    { t: 'Sudut prediksi tersedia pada awal setiap bulan.', a: 'B' },
    { t: 'Sudut prediksi berada dekat meja masuk perpustakaan.', a: 'B' },
    { t: 'Pengunjung menuliskan tebakan sederhana pada sudut prediksi.', a: 'B' },
    { t: 'Kegiatan tersebut memberikan hadiah kepada pemenang.', a: 'S' },
    { t: 'Salah satu contoh prediksi adalah waktu hujan.', a: 'B' },
    { t: 'Hasil prediksi dibagikan pada akhir bulan.', a: 'B' },
    { t: 'Pustakawan membagikan hasil prediksi.', a: 'B' },
    { t: 'Pengunjung tidak tertarik dengan kegiatan tersebut.', a: 'S' },
    { t: 'Suasana yang tercipta digambarkan ramah dan menyenangkan.', a: 'B' },
    { t: 'Teks menyebutkan bahwa kegiatan berlangsung di pusat perbelanjaan.', a: 'S' }
];
...
// Comment box stops the timer (completes the timed task).
document.getElementById('commentInput')
    .addEventListener('input', function () {
        const words = this.value.trim().split(/\s+/).filter(w => w.length > 0);
        document.getElementById('commentBtn').classList.toggle('ready', words.length >= 5);
    });
